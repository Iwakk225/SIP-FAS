...
// TAMBAHKAN INI SEBELUM PetugasModal
const AssignPetugasModal = ({ 
                ...
                <div className="p-6">
                    <div className="mb-4">
                        <h3 className="font-semibold text-gray-900 mb-2">
                            {selectedLaporanForAssign.judul}
                        </h3>
                        <p className="text-sm text-gray-600">
                            Lokasi: {selectedLaporanForAssign.lokasi}
                        </p>
                    </div>
...
export default function DashboardAdmin() {
    ...
    // HAPUS deklarasi PetugasModal yang lama dari sini
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            {showAssignPetugasModal && (
                <AssignPetugasModal
                    ...
                    selectedLaporanForAssign={selectedLaporanForAssign}
                    petugasData={petugasData}
                    handleAssignPetugas={handleAssignPetugas}
                />
            )}
