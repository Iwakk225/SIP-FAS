...
const DetailLaporanModal = ({ isOpen, onClose, laporan, onRatingSubmit }) => {
  ...
  const [riwayatPetugas, setRiwayatPetugas] = useState([]);
  ...
  const fetchRiwayatPetugas = async () => {
    if (laporan.status === "Selesai" && laporan.id) {
          ...
          {laporan.status === "Selesai" && (
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                ...
                Riwayat Petugas yang Menangani
              </h3>

              {isLoadingRiwayat ? (
                <div className="flex items-center justify-center py-8">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
                  <span className="ml-3 text-gray-600">Memuat riwayat petugas...</span>
                </div>
              ) : riwayatPetugas.length > 0 ? (
                <div className="space-y-3">
                  {riwayatPetugas.map((petugas, index) => (
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-2 space-y-1 text-xs text-gray-600">
                            ...
                            {petugas.dikirim_pada && (
                              <div className="flex items-center">
                                <Calendar className="w-3 h-3 mr-1" />
                                Dikirim: {formatDateTime(petugas.dikirim_pada)}
                              </div>
                            )}
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>Tidak ada riwayat petugas untuk laporan ini</p>
                </div>
              )}
            </div>
          )}
